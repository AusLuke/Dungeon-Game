...
public class Level3 extends GridPane
{
    ...
    Level3()
    {
        ...
        this.add(new Wall(), 6, 2);
        this.add(new Wall(), 7, 1);
        this.add(new Wall(), 7, 2);
        this.add(new Wall(), 7, 3);
        this.add(new Wall(), 9, 1);
        this.add(new Wall(), 9, 2);
        this.add(new Wall(), 9, 3);
        this.add(new Wall(), 10, 1);
        this.add(new Door(1), 10, 2);
        this.add(new Wall(), 10, 3);
        this.add(new Wall(), 11, 1);
        this.add(new Wall(), 11, 2);
        this.add(new Wall(), 11, 3);
        this.add(new Chest(), 0, 4);
